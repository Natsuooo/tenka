        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text('□カンタン検索'),
              SizedBox(height: 5),
              Text('　収録された130以上の添加物から，簡単・高速に検索できます．'),
              SizedBox(height: 15),
              Text('□Google検索'),
              SizedBox(height: 5),
              ...
              Text('□一括名表示'),
              SizedBox(height: 5),
              Text('　一括名には☆マーク，一括名表示可能な添加物には＊マークがついています．'),
              SizedBox(height: 40),
              Text(
                '食品表示ラベルの読み方',
                style: Theme.of(context).primaryTextTheme.headline5,
              ...
              Text('□原材料名'),
              SizedBox(height: 5),
              Text('　・原材料名は使用量の多い順に表示されている．'),
              SizedBox(height: 15),
              Text('□一括名表示'),
              SizedBox(height: 5),
              Text(
                  '　一括名表示が可能な添加物は，物質名の表示義務がなく一括名で表示可能なため，どの添加物が何種類使用されているか不明なものがあります．'),
              SizedBox(height: 10),
              Text('＜一括名表示添加物＞'),
              SizedBox(height: 5),
              Text(
